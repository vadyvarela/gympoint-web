...
export function* register({ payload }) {
  try {
    const { registrations } = payload;

    // yield call(api.post, 'registrations', registrations);

    const dataFormatted = { start_date: parseISO(registrations.start_date) };
    console.log.tron(dataFormatted);
    // const response = yield call(api.post, 'registrations', dataFormatted);
