...
import { formatPrice, formatDatePicker } from '~/utils/format';
...
export default function CreateRegistrations() {
  ...
  const [registrations, setEnrollment] = useState(null);
  ...
  return (
    <Container>
      <Form schema={schema} initialData={registrations} onSubmit={handleSubmit}>
        <Header>
