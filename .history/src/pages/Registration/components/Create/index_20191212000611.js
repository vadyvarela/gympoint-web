...
const schema = Yup.object().shape({
    student_id: Yup.string().required('O Campo titulo é obrigatorio'),
    plan_id: Yup.number().required('Campo Plano é obrigatorio'),
    start_date: Yup.number().required('Campo Data inicio é obrigatorio'),
});
