...
export default function EditRegistrations({ history }) {
    ...
    useEffect(() => {
        ...
        loadRegistrations();
    }, [registrationsPrevious.plan_id, registrationsPrevious.price, registrationsPrevious.registration_id, registrationsPrevious.start_date]);
