...
export default function EditRegistrations({ history }) {
    ...
    const [choosedRegistrations, setChoosedRegistrations] = useState('');
    ...
    const endDate = useMemo(() => {
        if (registrationsPrevious && choosedRegistrations === '') {
            return format(
        ...
        return '';
    }, [choosedRegistrations, registrationsPrevious]);
                            ...
                            <div className="selectElement">
                                <ReactSelect
                                    ...
                                    onChange={registration =>
                                        setChoosedRegistrations(registration)
                                    }
                                    options={registrations}
                                    defaultValue={
                                        registrationsPrevious.registration
                                    }
                                />
                            </div>
                        </ControlElement>
