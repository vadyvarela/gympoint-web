...
import { studentsSearchRequest } from '~/store/modules/students/actions';
...
export default function Edit({ history }) {
  ...
  function handleSubmit(data) {
    dispatch(studentsSearchRequest(studentPrevious.id, data));
  }
      ...
      >
        ...
        <Content>
          <div className="editRow">
            <ControlElement>
              <Input name="name" placeholder="Seu Nome" label="NOME COMPLETO" />
            </ControlElement>
            <ControlElement>
              <Input
                name="email"
